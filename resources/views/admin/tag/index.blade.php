...
<div class="card">
  <div class="card-header header-elements-md-inline">
    ...
    <div class="header-elements">
      <a data-url="{{route('admin.categories.create','tag')}}" href="javascript:void(0);" class="btn btn-sm btn-dark btn-labeled load_popup">Add New</a>
    </div>
  </div>
  <div class="card-body">
...
jQuery(document).ready(function($){
    ...
    datatableCategory = $('.datatable-category').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "{{route('admin.categories.index','tag')}}",
            "type": "get",
            "data": function ( data ) {
            }
        },
