            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="editor" id="editor" name="content">{{old('content')}}</textarea>
            ...
            <div class="sidebar-content">
              <div class="card">
                        ...
                        <select name="author" class="form-control">
                          @if(!empty($admins))
                            @foreach($admins as $admin)
                              <option value="{{$admin->id}}" @if(auth()->user()->id == $admin->id) selected="selected" @endif >{{$admin->name}}</option>
                            @endforeach
                          @endif
                        </select>
                              ...
                              <li class="nav-item pl-3 pb-1">
                                  <div class="form-check">
                                    <label class="form-check-label">
                                      <input type="checkbox" class="form-check-input-styled" name="categories[]" value="{{$category->id}}">{{$category->name}}</label>
                                  </div>
                              </li>
                            @endforeach
                          @endif
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="dropzone" id="dropzoneProductImageUpload"></div>
                        ...
                        <div class="row" id="products-images"></div>
                        </div>
                    </div>
                </div>
            </div>
